...
If we fix plot 1 to A. Then the remaining 11 plots have ${11} \choose {3}$ ways of choosing the other A. Without the loss of generality, we have that the marginal probability will be
